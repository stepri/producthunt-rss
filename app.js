    ...
    if (err) {
      ...
      _.each(data.posts, function(post){
        feed.item({
          ...
          description: '<img src="'+post.screenshot_url['850px']+'"><br><a href="'+post.discussion_url+'">Discussion link</a><br>Votes: '+post.votes_count+'<br>Comments: '+post.comments_count,
